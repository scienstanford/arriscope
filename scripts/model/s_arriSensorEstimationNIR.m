%% s_arriSensorEstimationNIR
%
% try to estimate the sensors with the NIR blocking filter on
...
testLights = {'blueSonyLight.mat','greenSonyLight.mat',...
    ...
    'whiteSonyLight.mat','whiteARRILight.mat','irSonyLight.mat'};  
%
...
%     plot(wave,log(thisLight * 5.453933991449514 -0.000976427089295));
%     hold on;
    plot(wave,(thisLight * 5.453933991449514 -0.000976427089295)); hold on;
end
...
title('MCC under 7 different lights')
%}
...
rgbImages = {'MacbethCc_blue17_fIRoff.ari','MacbethCc_green17_fIRoff.ari', ...
    'MacbethCc_red17_fIRoff.ari', 'MacbethCc_violet17_fIRoff.ari', ...
    'MacbethCc_white17_fIRoff.ari','MacbethCc_arriwhite20_fIRoff.ari','MacbethCc_ir7_fIRoff.ari'};
...
comment = 'ARRI sensors estimated by the script s_arriSensorEstimationNIR.m';
% fname = fullfile(arriRootPath,'data','sensor','ARRIestimatedSensorsNIR');
